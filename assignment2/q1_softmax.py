...
def softmax(x):
  ...
  ### YOUR CODE HERE
  rows_max = tf.reduce_max(x, reduction_indices=[1], keep_dims=True)
  exponentials = tf.exp(x - rows_max)
  out = exponentials / tf.reduce_sum(exponentials, reduction_indices=[1], keep_dims=True)
  ### END YOUR CODE
...
def cross_entropy_loss(y, yhat):
  ...
  """
  ### YOUR CODE HERE
  out = tf.reduce_sum(-tf.reduce_sum(tf.to_float(y) * tf.log(yhat), reduction_indices=[1]))
  ### END YOUR CODE
  return out
