...
REGULARIZATION = [0.00001,0.00003,0.0001,0.0003,0.001,0.003,0.01,0.03,0.1,0.3]   # Assign a list of floats in the block below
### YOUR CODE HERE
### END YOUR CODE
...
### YOUR CODE HERE 
max_result = max(results, key=lambda result: result["train"])
BEST_REGULARIZATION = max_result["reg"]
BEST_WEIGHTS = max_result["weights"]
### END YOUR CODE
